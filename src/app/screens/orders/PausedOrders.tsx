...
const PausedOrders = ({ setValue, card }: PausedOrdersProps) => {
	...
	const singleProductClickHandle = (productId: string) => {
...
// TODO: Bu qismida single product click bo'lganda ochiladigan qilishim kerak
