...
const UserLogin = () => {
	...
	const handleLoginRequest = async (e: T) => {
		e.preventDefault();
		try {
			...
			<div className="flex  rounded-lg  flex-col sm:w-[600px] space-y-2 p-2  justify-center items-center">
				<div className="w-full justify-between flex">
					<div className="flex space-x-2">
						<NavLink to={"/store/process/signup"}>
							<Button
				...
				<form
					...
					className="relatve space-y-3 backdrop-blur-sm rounded-lg w-full px-1 sm:px-2 py-2 sm:py-6 border"
				>
